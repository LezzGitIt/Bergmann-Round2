...
##See other script 
capri.df3 <- capri.df3 %>% mutate(rowID = row_number()) #OLD: 8.14.23 Adding row_number() here, but notice row_number was previously added above. NEED TO CONFIRM BEFORE MERGING ENVIRONMENTAL DATA W/ ELLY
#nrow(capri.df3) #5914 rows
